...
from src.widget import return_date_from_str, return_mask_card_account


@pytest.mark.parametrize(
    "information_on_card, expected",
    [
...
@pytest.mark.parametrize(
    "string_with_date, expected",
    [("2018-07-11T02:26:18.671407", "11.07.2018"), ("2019-06-10T02:26:18.671407", "10.06.2019")],
)
